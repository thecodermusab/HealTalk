...
export default function ProgressPage() {
  ...
  const moodOptions = [
    { value: "great", icon: Smile, label: "Great", color: "success" },
    { value: "good", icon: Smile, label: "Good", color: "primary" },
    { value: "okay", icon: Meh, label: "Okay", color: "secondary" },
    { value: "bad", icon: Frown, label: "Bad", color: "accent" },
    { value: "terrible", icon: Frown, label: "Terrible", color: "red-500" },
  ];
          ...
          <div className="grid grid-cols-5 gap-4 mb-8">
            {moodOptions.map((mood) => (
              ...
              >
                <mood.icon
                  size={32}
                  className={selectedMood === mood.value ? `text-${mood.color}` : "text-text-secondary"}
                />
          ...
          <div className="space-y-3">
            {goals.map((goal) => (
              ...
              >
                ...
                >
                  {goal.completed && <Check className="text-white" size={16} />}
                </div>
                <span
                  className={`flex-1 ${
                    goal.completed
