...
export function PodcastCard({ episode }: PodcastCardProps) {
  return (
    <div className="group flex h-full w-full flex-col gap-5 rounded-[18px] bg-[#FBF9F6] p-4 sm:p-5 md:min-h-[600px] overflow-hidden">
      {/* Cover Block */}
      ...
      {/* Info Block */}
      <div className="flex flex-col gap-3 px-1 flex-grow min-w-0">
        {/* Episode Number + Host */}
        ...
        <div className="mt-auto flex flex-wrap items-center gap-x-4 gap-y-2 pt-2">
          <Link
            ...
            className="inline-flex max-w-full items-center gap-1.5 group/link min-w-0"
          >
            ...
            <span className="text-[11px] font-bold uppercase tracking-wide text-[#1a1a1a] group-hover/link:underline truncate">
              Spotify
            </span>
          </Link>
