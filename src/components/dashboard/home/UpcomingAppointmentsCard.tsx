...
export function UpcomingAppointments() {
  ...
  const [newApptType, setNewApptType] = useState("Individual Counselling");
        ...
        <table className="w-full min-w-[600px]">
          <thead>
            <tr className="text-left bg-gray-50 border-b border-gray-100">
              <th className="py-3 px-4 font-medium text-gray-500 text-sm rounded-l-lg">Appoint for</th>
                ...
                <tr key={apt.id} className="group hover:bg-gray-50/50 transition-colors">
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                       <span className={cn(
                         ...
                         apt.type.includes("Individual") ? "bg-blue-50 text-blue-600" : 
                         apt.type.includes("Couple") ? "bg-pink-50 text-pink-500" :
                  ...
                  <td className="py-4 px-4 text-right">
                     <div className="flex items-center justify-end gap-2">
                       <Link href={`/psychologist/dashboard/messages?chatId=${apt.id}&action=call`}>
                       ...
                       <Link href={`/psychologist/dashboard/messages?chatId=${apt.id}&action=reschedule`}>
